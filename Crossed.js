var Crossed = function () {
    ...
    function contenu(){
        ...
        if (N == 6660) Crossed.selection(6);
        else if (N == 19783) Crossed.selection(5);
    }
    ...
    return {
        selection: function(n){
            nCourse = n;
            onCourse = 1;
            perso[0].x = course[n].persos[0][0];
            perso[0].y = course[n].persos[0][1];
            perso[0].vx = course[n].persos[0][2];
            perso[0].vy = course[n].persos[0][3];
            perso[1].x = course[n].persos[1][0];
            perso[1].y = course[n].persos[1][1];
            perso[1].vx = course[n].persos[1][2];
            perso[1].vy = course[n].persos[1][3];
	...
	init: function( W, H ) {
        ...
        keysPress: function(keyCode,ctx,W,H){
